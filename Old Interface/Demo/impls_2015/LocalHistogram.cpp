 ...
 */
int LocalHistogram::distanceOffset(double maxDistance, double distance,
		int cols) {
...
double LocalHistogram::bhattacharyyaMetric(LocalHistogram sceneHistogram,
	...
	vector<vector<int> > refMatrix = this->constructorMatrix(angleAcc,
			distanceAxis, refTotalEntries);
