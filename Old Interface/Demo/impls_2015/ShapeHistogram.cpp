 ...
 * @return: number of entries in PGH
 */
 ...
 * @return: the maximum distance in PGH
 */
 ...
 * @return: the matrix presents for shape PGH
 */
 ...
 * @return: list of local histogram of a shape PGH
 */
 ...
 * @parameter 1: localHistograms - list of local PGH
 * @parameter 2: angleAcc - angle accuracy
 * @parameter 3: cols - distance accuracy
 * @return: matrix presents for shape PGH
 */
vector<vector<int> > ShapeHistogram::constructMatPGH(
		vector<LocalHistogram> localHistograms,
 ...
 * @parameter 1: matrixPGH - matrix presents for shape PGH
 * @parameter 2: fileName - save file path
 */
void ShapeHistogram::writeMatrix(vector<vector<int> > matrixPGH,
		string fileName) {
 ...
 * @parameter 2: cols - the distance accuracy
