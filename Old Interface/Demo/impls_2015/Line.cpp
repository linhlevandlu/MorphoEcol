 ...
 * @return: Three parameters in line equation (a, b, c)
 */
 ...
 * @parameter 1: equation1 - line's equation of the first line
 * @parameter 2: equation2 - line's equation of the second line
