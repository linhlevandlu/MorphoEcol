...
/*
 * Get the list of closest lines in a list of lines
 * @parameter: sceneLines - list of lines
 * @return: list of couple of closest lines
 */
 ...
 * @parameter 5: sgmethod - method used to segment image
 ...
 * @parameter 5 - output: ePoint - the reference point on scene image
 ...
 * @parameter 6: sgmethod - method used to segment image
 * @parameter 7: save - save the result into file or not
 */
...
/*
 * Save the list of estimated landmarks into a file
 * @parameter 1: esLandmarks - list of estimated landmarks
 * @parameter 2: savePath - the path of file which used to save the estimated result.
 */
