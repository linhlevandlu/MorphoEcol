...
/*
 * Sort the list of points (presented for edge) by the x coordinate
 */
void Edge::sortByX() {
...
/*
 * Sort the list of points (presented for edge) by the y coordinate
 */
void Edge::sortByY() {
	std::sort(this->listOfPoints.begin(), this->listOfPoints.end(),
			yComparation);
 ...
 * @return: true, if the number of points in "this edge" greater than the number of points in "object edge"
 * 			false, if the number of points in "this edge" smaller than the number of points in "object edge"
 */
