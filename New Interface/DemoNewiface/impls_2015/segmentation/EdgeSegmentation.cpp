 ...
 * @parameter 2: sgmethod - method used to segment image
...
vector<Line> EdgeSegmentation::postLineSegment(Image image,
		Image::SegmentMethod sgmethod) {
	int thresh = 0;
 ...
 * @parameter 3: method - method used to segment image
 * @parameter 4: save - save the result into file or not
 */
...
/*
 * Save the list of lines into file
 * @parameter 1: lines - list of lines
 * @parameter 2: savePath - the path of file which used to save the list of lines
 */
...
/*
 * Segmentation of an image and save the result into a file
 * @parameter 1: image - the image
 * @parameter 2: sgmethod - method used to segment image
 * @parameter 3: savePath - the path of file which used to save the result
 */
