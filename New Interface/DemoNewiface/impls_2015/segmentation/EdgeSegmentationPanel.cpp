...
/*
 * Constructor of segmentation parameters
 */
 ...
 * @parameter 1: sgmethod - method used to segment image
 * @parameter 2: threshold - the value used to threshold
 */
...
/*
 * The event changes the threshold value
...
/*
 * The event changes the segmentation method to Otsu method
 * @parameter: checked - Otsu method chosen or not
 */
...
/*
 * The event changes the segmentation method to "other method"
 * @parameter: checked - "Other method" chosen or not
 */
