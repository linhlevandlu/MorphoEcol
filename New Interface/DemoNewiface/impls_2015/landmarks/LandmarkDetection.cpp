 ...
 * @parameter 8 - output: mcResult - list of estimated landmarks
 * @parameter 9 - output: ePoint - the location of reference point in scene image
...
/*
 * Refine the estimated landmarks
 * @parameter 1: mImage - the reference image
 * @parameter 2: sImage - the scene image
 * @parameter 3: manualLM - list of manual landmarks
 * @parameter 4: esLandmarks - list of estimated landmarks
 ...
 * @parameter 8: ePoint - the location of reference point in scene image
 * @return: the list of estimated landmarks and present it on the scene image
 */
...
/*
 * Save the estimated into a file
 * @parameter 1: esLandmarks - the list of estimated landmarks
 * @parameter 2: path - the file path which used to save the result
 */
...
/*
 * Load the original landmarks
 * @parameter 1: image - the image
 * @parameter 2: lmPath - the path of file which contains the landmarks
 * @parameter 3: orgLandmarks - list of original landmarks
 * @return: the image with the original landmarks (presented by matrix)
 */
