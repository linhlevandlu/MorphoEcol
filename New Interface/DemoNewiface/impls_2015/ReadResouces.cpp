...
/*
 * Read the resource parameters from file
 * @parameter: filePaht - the file contains the parameters
 * @return: the dictionary contains the key and value of the resources
 */
