 ...
 * @parameter 2: result - the matrix presented the segmentation result
 * @parameter 3: sgmethod - method used to segment image
...
/*
 * Image segmentation
 * @parameter 1: image - the model image
 * @parameter 2 - output: result - present the segmentation result
 * @parameter 3: sgmethod - method used to segment image
 */
 ...
 * @parameter 3: sgmethod - method used to segment image
 * @parameter 4: save - save the results into files or not (1 or 0).
...
void Scenario::edgeSegmentationDirectory(QString inputFolder,
		QString saveFolder, Image::SegmentMethod sgMethod, int save) {
	EdgeSegmentation edgeSegment;
	edgeSegment.segmentDirectory(inputFolder.toStdString(),
			saveFolder.toStdString(), sgMethod, save);
}
 ...
 * @parameter 4: sgmethod - method used to segment image
 * @parameter 5: result - the matrix presented the result (presents for image)
 * @parameter 6: matrix - the matrix presents for shape PGH
 ...
 * @parameter 5: distanceAcc - the accuracy of distance axis (250, 500, 1000)
 * @parameter 6: sgmethod - method used to segment image
 ...
 * @parameter 6: fileSave - the path to save the results
 * @parameter 7: sgmethod - method used to segment image
 */
 ...
 * @parameter 4: distanceAcc - the accuracy of distance axis (250, 500, 1000)
 */
 ...
 * @parameter 4: sgmethod - method used to segment image
 * @parameter 5: esLandmarks - estimated landmarks
 ...
 * @parameter 4: tsize - size of template
 ...
 * @parameter 3: sceneImage - the scene image
 * @parameter 4: size - size of template
 * @parameter 5 - output: ebary - the bary point of the landmarks
 ...
 * @parameter 6: sgmethod - method used to segment image
 * @parameter 7: mcResult - list of estimated landmarks
 * @parameter 8: angle - different angle between model and scene image
 * @parameter 9: ePoint - the position of reference point in scene image
 * @return: the matrix presented the estimated landmarks(as image)
 */
 ...
 * @parameter 7: sgmethod - method used to segment image
 * @parameter 8: save - save the result into file or not
 */
 ...
 * @parameter 3: lmPath - the reference landmarks path
 * @parameter 4: templSize - size of template (small image)
 * @parameter 5: sceneSize - size of image (large image)
 * @parameter 6: sgmethod - method used to segment image
 * @parameter 7 - output: ebary - the bary point of the landmarks
 * @return: the centroid of estimated landmarks
 */
 ...
 * @parameter 4: lmFolder - the scene landmarks folder (manually)
 * @parameter 5: templSize - size of reference landmarks bounding box
 * @parameter 6: sceneSize - size of estimated landmark bounding box
 * @parameter 7: savePath - the path to save the result
 * @parameter 8: sgmethod - method used to segment image
 */
...
/*
 * Loading the manual landmarks on image
 * @parameter 1: image - the model image
 * @parameter 2: lmPaht - the path of manual landmarks file
 * @parameter 3: orgLandmarks - list of manual landmarks from the file
 */
