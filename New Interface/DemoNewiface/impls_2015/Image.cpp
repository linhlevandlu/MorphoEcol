 ...
 */
void Image::setFileName(string filePath) {
	this->fileName = filePath;
}

/*
 * Get the Otsu value (used to threshold image)
 * @return: Otsu value
 */
...
/*
 * Broken the edge into list of approximate lines
 * @parameter: edges - list of edges
 * @return: list of approximate lines which were presented for list of edges
 */
vector<Line> Image::getApproximateLines(vector<Edge> edges) {
	vector<Line> totalLines;
	vector<Edge> drawEdge = edges;
 ...
 * @parameter 1: method - method used to segment the image
 * @parameter 2: thresholdValue - the value used to segment the image
 * @return: list of approximate lines (result after segmentation)
 */
...
/*
 * Get the string from current time
...
/*
 * Loading the original landmarks
 * @parameter 1: matImage - the image
 * @parameter 2: lmPath - the original landmarks file
 * @parameter 3: orgLandmakrs - list of original landmarks
 * @return: Image with original landmarks
 */
 ...
 * @parameter 1: output - the image(input and output)
